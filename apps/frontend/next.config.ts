        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.microcms.io https://www.google-analytics.com https://va.vercel-scripts.com https://vitals.vercel-insights.com https://*.form.newt.so",
              "frame-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self' https://*.form.newt.so",
